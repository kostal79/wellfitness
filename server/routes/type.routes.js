...
router.post("/create", isAdmin, multerTypesMiddleware.single("image"), typeController.create)
...
router.put("/:typeId/image", isAdmin,multerTypesMiddleware.single("image"), typeController.updateImage);
